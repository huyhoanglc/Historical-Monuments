      ...
      <div class="row">
        <div class="col-md-6 d-flex align-items-stretch">
          <div class="card" style={{backgroundImage: "url(img/Region/Sydney-05.jpg)"}} data-aos="fade-up" data-aos-delay="100">
            <div class="card-body">
              <h5 class="card-title"><a href="/South">Southestern Hemisphere</a></h5>
              ...
              <div class="read-more"><a href="/South"><i class="bi bi-arrow-right"></i> Read More</a></div>
            </div>
          </div>
        </div>
        <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
          <div class="card" style={{backgroundImage: "url(img/Region/Eiffel-03.jpg)"}} data-aos="fade-up" data-aos-delay="200">
            <div class="card-body">
              <h5 class="card-title"><a href="/West">Western hemisphere</a></h5>
              ...
              <div class="read-more"><a href="/West"><i class="bi bi-arrow-right"></i> Read More</a></div>
            </div>
          </div>
        ...
        <div class="col-md-6 d-flex align-items-stretch mt-5">
          <div class="card" style={{backgroundImage: "url(img/Region/Statue-02.jpg)"}} data-aos="fade-up" data-aos-delay="100">
            <div class="card-body">
              <h5 class="card-title"><a href="/North">Noththern Hemisphere</a></h5>
              <p class="card-text">"
The Northern Hemisphere is home to a diverse array of monuments that showcase the cultural, historical, and architectural richness of the region. Here are descriptions of some notable monuments in the Northern Hemisphere"</p>
              <div class="read-more"><a href="/North"><i class="bi bi-arrow-right"></i> Read More</a></div>
            </div>
          </div>
        </div>
        <div class="col-md-6 d-flex align-items-stretch mt-5">
          <div class="card" style={{backgroundImage: "url(img/Region/Himeji-03.jpg)"}} data-aos="fade-up" data-aos-delay="200">
            <div class="card-body">
              <h5 class="card-title"><a href="/East">Eastern Hemisphere</a></h5>
              ...
              <div class="read-more"><a href="/East"><i class="bi bi-arrow-right"></i> Read More</a></div>
            </div>
          </div>
        </div>
      </div>
      <div class="wonders">
          <div class="card"  data-aos="fade-up" data-aos-delay="100">
            <div class="card-body">
              <h5 class="card-title"><a href="/Wonder">Seven Wonders</a></h5>
              ...
              <div class="read-more"><a href="/Wonder"><i class="bi bi-arrow-right"></i> Read More</a></div>
            </div>
          </div>
        </div>
